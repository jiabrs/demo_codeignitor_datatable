-- FIX FOR BUG #57 and #75

-- CREATE TEMPORARY TABLE
CREATE TABLE CTMCMA.ELEM_TMP LIKE CTMCMA.ELEM;

-- COPY RECORDS FROM ELEM TO ELEM_TMP
...
-- CREATE ELEM WITH PRECISION FIX
...
-- POPULATE ELEM WITH RECORDS
INSERT INTO CTMCMA.ELEM (ELEM_ID,APP,ELEM_TP,ELEM_RT,ELEM_TRGT,ELEM_TRIGR,PCT,PYMT_LMT,SHR,ON_INV_FLG,UNT_DIV,ELEM_DESC,ELEM_NM,ENBL)
SELECT ELEM_ID,APP,ELEM_TP,ELEM_RT,ELEM_TRGT,ELEM_TRIGR,PCT,PYMT_LMT,SHR,ON_INV_FLG,UNT_DIV,ELEM_DESC,ELEM_NM,ENBL
FROM CTMCMA.ELEM_TMP;

-- REMOVE TEMP TABLE
DROP TABLE CTMCMA.ELEM_TMP;